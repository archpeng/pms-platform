...
export type ApiBoundaryErrorCode =
  ...
  | 'RESERVATION_CREATE_WORKFLOW_NOT_IMPLEMENTED'
  ...
  | 'GUEST_ID_CARD_DRAFT_NOT_FOUND'
  | 'GUEST_ID_CARD_DRAFT_NOT_ACTIVE'
  | 'GUEST_ID_CARD_CARD_PAYLOAD_MISMATCH'
  | 'GUEST_ID_CARD_ARCHIVE_NOT_IMPLEMENTED';
