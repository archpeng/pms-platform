...
import { SqliteSandboxGuestIdCardStore } from './guestIdCardStore.js';

export abstract class SqliteSandboxPendingActionStore extends SqliteSandboxGuestIdCardStore {
